...
namespace Steeltoe.Common.Http
{
  public static class HttpClientHelper
  {
        ...
        ILogger logger = null)
    {
      ...
      var request = new HttpRequestMessage(HttpMethod.Post, new Uri(new Uri(accessTokenUri), Security.Authentication.CloudFoundry.CloudFoundryDefaults.AccessTokenUri));
